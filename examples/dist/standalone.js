...
var Select = _react2['default'].createClass({
	...
	checkScrolledToBottom: function checkScrolledToBottom() {
		...
		if (!menu) return;
		console.log('checkScrolledToBottom', { menu: menu });
		console.log('menu.scrollHeight(' + menu.scrollHeight + ') > menu.offsetHeight(' + menu.offsetHeight + ')', menu.scrollHeight > menu.offsetHeight, '!(menu.scrollHeight - menu.offsetHeight - menu.scrollTop(' + menu.scrollTop + ')', !(menu.scrollHeight - menu.offsetHeight - menu.scrollTop));
		if (menu.scrollHeight > menu.offsetHeight && !(menu.scrollHeight - menu.offsetHeight - menu.scrollTop)) {
